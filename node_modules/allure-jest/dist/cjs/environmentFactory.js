...
var hostname = _nodeOs.default.hostname();
var createJestEnvironment = Base => {
  ...
  return _Class_brand = /*#__PURE__*/new WeakSet(), class extends Base {
    ...
    constructor(config, context) {
      ...
      this.testPath = context.testPath.replace(projectConfig.rootDir, "").replace(_nodePath.sep, "");
  ...
  function _startTest(test) {
    ...
    var threadLabel = ALLURE_THREAD_NAME || JEST_WORKER_ID || _nodeProcess.default.pid.toString();
    var hostLabel = ALLURE_HOST_NAME || hostname;
    var packageLabel = (0, _nodePath.dirname)(this.testPath).split(_nodePath.sep).join(".");
    _assertClassBrand(_Class_brand, this, _startScope).call(this);
    var testUuid = this.runtime.startTest({
      ...
      labels: [{
        ...
        value: packageLabel
      }, ...(0, _reporter.getEnvironmentLabels)()]
    ...
    this.runtime.updateTest(testUuid, result => {
      ...
      result.labels.push(...(0, _reporter.getSuiteLabels)(newTestSuitePath));
    });
  ...
  function _handleTestStart(test) {
    ...
    this.runtime.updateTest(testUuid, result => {
      result.stage = _allureJsCommons.Stage.RUNNING;
    });
  }
  ...
  function _handleTestSkip(test) {
    ...
    this.runtime.updateTest(testUuid, result => {
      result.stage = _allureJsCommons.Stage.PENDING;
